...
function validateForm() {
    ...
    if (atpos < 1 || dotpos < atpos + 2 || dotpos + 2 >= email.length) {
        ...
        $.ajax({
            ...
            url: "https://formcarry.com/s/KUFCxYCBoPJ",
            method: "POST",
            data: datastring,
            dataType: "json"
        });
        $('#js-form-message').addClass('text-success text-large').text('Thanks for your interest. We\'ll be in touch as soon as possible.');
        return false;
    }
}